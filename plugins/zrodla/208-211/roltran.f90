module plugin_mod
	...
	character(kind=c_char, len=32), target, save :: name_str = "Korektor Dat" // c_null_char
    	character(kind=c_char, len=256), target, save :: help_str = &
        "Ta wtyczka dba o poprawne lata i zamienia rok 2008 na 2012, " // &
        "zeby nie bylo problemow ze smierdzacym rokiem." // c_new_line // &
